      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              The ultimate multiplayer quiz platform for learning, competing, and having fun with friends.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/quizzes" className="text-muted-foreground hover:text-primary transition-colors">
                  Browse Quizzes
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/leaderboards" className="text-muted-foreground hover:text-primary transition-colors">
                  Leaderboards
                </a>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-sm text-muted-foreground">
            © 2024 Quiz Together. All rights reserved.
          </div>
